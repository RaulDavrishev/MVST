...
while(oci_fetch($all_row)){
		echo '<section class="section section--bg" data-bg="img/section/section.jpg">
		 <div class="container">
			<div class="row">
				<!-- title -->
				<div class="col-12">
					<h1 class="details__title">'.oci_result($all_row, 'TITLE').'</h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-5">
								<div class="card__cover">
									<img src="img/covers/'.oci_result($all_row, 'MOVIE_ID').'.jpg" alt="">
								</div>
							</div>
							<!-- end card cover -->
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
								<div class="card__content">
									<div class="card__wrap">
										<span class="card__rate"><i class="icon ion-ios-film"></i>movie</span>
									...
									<ul class="card__meta">
										<li><span>Genre:</span><a>'.oci_result($all_row, 'GENRE_NAME').'</a>
										<li><span>Year:</span><a>'.oci_result($all_row, 'YEAR').'</a></li>
										<li><span>Time:</span><a>'.oci_result($all_row, 'LENGTH').' min</a></li>
										<li><span>Country:</span><a>'.oci_result($all_row, 'COUNTRY_NAME').'</a> </li>
										<li><span>Starring:</span><a>'.oci_result($all_row, 'PERSON_NAME').' / '
										.oci_result($all_row, 'GENDER').'</a></li>
									</ul>

									<div class="card__description card__description--details">'
										.oci_result($all_row, 'DESCRIPTION').
									'</div>
								</div>
							</div>
							<!-- end card content -->
